...
export default function SidebarTabs({ activeTab, onChangeTab, recordsCount }) {
  ...
  return (
    <MotionAside
      ...
      className="ui-panel interactive-lift h-fit rounded-3xl p-4 sm:rounded-4xl sm:p-5 lg:sticky lg:top-5 lg:self-start"
    >
      ...
      <motion.div
        ...
        className="mt-4 rounded-2xl border border-cyan-300/40 bg-cyan-50/70 px-3 py-2 text-xs font-semibold text-cyan-800 dark:border-cyan-700/60 dark:bg-cyan-950/30 dark:text-cyan-300"
      >
